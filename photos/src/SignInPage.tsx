...
import { FORCE_REMOTE } from "./lib/data-source-context";

/**
 * Photos' sign-in page, mounted by `src/main.tsx` for the `/sign-in` client
 * route. The app owns the route, the markup and the copy; the
